...
public class Route : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        for (float t = 0; t <= 1; t += 0.05f)
        {
            ...
            gizmosPosition = controlPoints[1].position + Mathf.Pow(1 - t, 2) * (controlPoints[0].position - controlPoints[1].position) + Mathf.Pow(t, 2) * (controlPoints[2].position - controlPoints[1].position);
        ...
        Gizmos.DrawLine(new Vector3(controlPoints[0].position.x, controlPoints[0].position.y, controlPoints[0].position.z), new Vector3(controlPoints[1].position.x, controlPoints[1].position.y, controlPoints[1].position.z));
        Gizmos.DrawLine(new Vector3(controlPoints[2].position.x, controlPoints[2].position.y, controlPoints[2].position.z), new Vector3(controlPoints[1].position.x, controlPoints[1].position.y, controlPoints[1].position.z));
